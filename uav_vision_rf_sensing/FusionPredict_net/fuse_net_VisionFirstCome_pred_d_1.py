...
class PredModel(nn.Module):
    ...
    def denormalize_output(self,x):
        d = denormalize_distance(x[:,0]).unsqueeze(1)
        return d
...
def train_model(right_model, model, train_loader, test_loader, device, save_path, epochs=10, lr=1e-3):
    ...
    log_dir = f"runs/Net_pred_ab_Fuse/Fuse_net_timeEst_d_{timestamp}"
...
if __name__ == "__main__":
    ...
    model_path = 'weights_P6/fuse_net_timeEst_d_e100_1_snr0.pth'
    epoch = 100
