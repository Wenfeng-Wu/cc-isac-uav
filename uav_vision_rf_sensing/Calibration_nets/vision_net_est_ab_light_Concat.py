...
class Vision_Net(nn.Module):
    ...
    def forward(self, images, box_center, box_size):
        ...
        angel_feature = torch.cat([box_cross , img_cross], dim =-1)
...
if __name__ == "__main__":
    ...
    model_path = 'weights/vision_net_est_Concat_ab_e100.pth'
    output_path = '../simulate_data/data_P6/vision_net_est_Concat_ab_new.pth'
    epoch = 100
